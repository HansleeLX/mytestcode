...
<head>
    ...
    <title>Specialist / Individual Contributor</title>
...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row col-lg-10 col-lg-offset-1 custyle">
                    <h4><b>Competencies - Specialist/Individual Contributor</b></h4>
                    <p>
                        We believe that the most common and relevant competencies which are required can be broken down to the following 5 types. Please select the ones that are relevant to this role and reorder them using the simple interface.</p>
                    ...
                    <div class="parent">
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                     <ul id="target1" class="target connected">
                                </ul>
                                </div>
                            </div>
                    ...
                    <div class="text-left">
						...
						<div style="float:right;">
							<form action="Position_Chart.php" method="post" id="ol_executive_form" name="ol_executive_form">
								...
								<input type="submit" class="btn btn-default" name="pf_submit" id="pf_submit" value="Save & Next >" style="background-color:#F2923F; font-size:14px; color:#FFFFFF;" onClick="ol_youngprofessionaljump()">
							</form>
						</div>
                    </div>
    ...
    Sortable.create(source1, {
        group: "sorting",
        sort: true,
        animation: 150
    });
    Sortable.create(target1, {
        group: "sorting",
        sort: true
    });
    </script>
