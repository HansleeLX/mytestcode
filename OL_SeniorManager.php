...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row col-lg-10 col-lg-offset-1 custyle">
                    <h4><b> Competencies - Senior Manager</b></h4>
                    <p>
                        We believe that the most common and relevant competencies which are required can be broken down to the following 4 types. Please select the ones that are relevant to this role and reorder them using the simple interface.</p>
                    ...
                    <div class="parent">
                        <div class="col-sm-6">
                            <div class="panel panel-warning">
                                ...
                                <div class="panel-body">
                                    <ul id="source3" class="source connected">
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <ul id="target3" class="target connected">
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-left">
						...
						<div style="float:right;">
							<form action="Position_Chart.php" method="post" id="ol_executive_form" name="ol_executive_form">
								...
								<input type="submit" class="btn btn-default" name="pf_submit" id="pf_submit" value="Save & Next >" style="background-color:#F2923F; font-size:14px; color:#FFFFFF;" onClick="ol_seniormanagerjump()">
							</form>
						</div>
                    </div>
    ...
    Sortable.create(source3, {
        group: "sorting",
        sort: true,
        animation: 150
    });
    Sortable.create(target3, {
        group: "sorting",
        sort: true
    });
    </script>
